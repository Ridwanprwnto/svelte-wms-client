<!-- Header.svelte -->
<script>
  // Tambahkan logic jika nanti butuh reactive data
</script>
                                  ...
                                  <div class="hd-message-info hd-task-info">
                                      <div class="skill">
                                          ...
                                          <div class="progress">
                                              ...
                                              <div class="progress-bar wow fadeInLeft" data-progress="93%" style="width: 93%" data-wow-duration="1.5s" data-wow-delay="1.2s">
                                                  <span>93%</span>
                                              </div>
                                          </div>
                                          <div class="progress">
